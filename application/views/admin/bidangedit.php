...
<div class="card-body">
<form action="<?php base_url('bidang/edit'); ?>" method="post" enctype="multipart/form-data">
<div class="form-group">
    <input type="hidden" name="id" value="<?php echo $bidang->id_bidang ?>">
<label for="nama_bidang">Nama Bidang</label>
<input type="text" class="form-control <?= form_error('nama_bidang')?'is-invalid':''?>" name="nama_bidang" id="nama_bidang" value="<?php echo $bidang->nama_bidang ?>" />
