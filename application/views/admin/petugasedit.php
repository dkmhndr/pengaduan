...
<div class="form-group">
    <label for="id_bidang">Nama Bidang (Pilih ADMIN bila mengubah ke akun Admin)</label>
...
<div class="form-group">
    ...
    <input type="text" class="form-control <?= form_error('nama_petugas')?'is-invalid':''?>" name="nama_petugas" id="nama_petugas" value="<?= $value->nama_petugas ?>" />
    <div class="invalid-feedback"><?= form_error('nama_petugas'); ?></div>
</div>
<div class="form-group">
    <label for="username">Username</label>
    <input type="text" class="form-control <?= form_error('username')?'is-invalid':''?>" name="username" id="username" placeholder="Username" value="<?= $value->username ?>" />
    <div class="invalid-feedback"><?= form_error('username'); ?></div>
</div>
<div class="form-group">
    <label for="password1">Kata Sandi</label>
    <input type="password" class="form-control <?= form_error('password1')?'is-invalid':''?>" name="password1" id="password1" placeholder="Kata Sandi" />
    <div class="invalid-feedback"><?= form_error('password1'); ?></div>
</div>
<div class="form-group">
    <label for="password2">Konfirmasi Kata Sandi</label>
    <input type="password" class="form-control <?= form_error('password2')?'is-invalid':''?>" name="password2" id="password2" placeholder="Konfirmasi Kata Sandi" />
    <div class="invalid-feedback"><?= form_error('password2'); ?></div>
</div>
<div class="form-group">
    <label for="telp">No Telp</label>
    <input type="tel" class="form-control <?= form_error('telp')?'is-invalid':''?>" name="telp" id="telp" placeholder="No Telepon" value="<?= $value->telp ?>" />
    <div class="invalid-feedback"><?= form_error('telp'); ?></div>
</div>
<div class="form-group">
    <label for="level">Level</label>
    <select class="form-control <?= form_error('level')?'is-invalid':''?>" name="level" id="level" placeholder="Level">
