...
<div class="form-group">
    ...
    <input type="text" class="form-control <?= form_error('nama_petugas')?'is-invalid':''?>" name="nama_petugas" id="nama_petugas" placeholder="Nama Petugas" />
...
<div class="form-group">
    ...
    <input type="tel" class="form-control <?= form_error('telp')?'is-invalid':''?>" name="telp" id="telp" placeholder="No Telepon" />
